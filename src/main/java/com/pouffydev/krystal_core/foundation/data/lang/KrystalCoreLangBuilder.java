...
public class KrystalCoreLangBuilder {
    String namespace;
    MutableComponent component;
    
    public KrystalCoreLangBuilder(String namespace) {
        this.namespace = namespace;
    }
    
    public KrystalCoreLangBuilder space() {
        return text(" ");
    }
    
    public KrystalCoreLangBuilder newLine() {
        return text("\n");
    }
     ...
     * @return
     */
    public KrystalCoreLangBuilder translate(String langKey, Object... args) {
        return add(Components.translatable(namespace + "." + langKey, KrystalCoreLang.resolveBuilders(args)));
    }
     ...
     * @return
     */
    public KrystalCoreLangBuilder text(String literalText) {
     ...
     * @return
     */
    public KrystalCoreLangBuilder text(ChatFormatting format, String literalText) {
     ...
     * @return
     */
    public KrystalCoreLangBuilder text(int color, String literalText) {
     ...
     * @return
     */
    public KrystalCoreLangBuilder add(KrystalCoreLangBuilder otherBuilder) {
     ...
     * @return
     */
    public KrystalCoreLangBuilder add(MutableComponent customComponent) {
     ...
     * @return
     */
    public KrystalCoreLangBuilder style(ChatFormatting format) {
        assertComponent();
     ...
     * @return
     */
    public KrystalCoreLangBuilder color(int color) {
        assertComponent();
    ...
    public void forGoggles(List<? super MutableComponent> tooltip, int indents) {
        tooltip.add(KrystalCoreLang.builder()
